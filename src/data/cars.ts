...
export const cars: Car[] = [
  { 
    ...
    description: [
      ...
      "Emir Rent A Car filosunda yer alan tüm araçlarımız, periyodik olarak yetkili servislerde detaylı bakımlardan geçirilmekte ve her müşteri teslimatı öncesinde anti-bakteriyel solüsyonlarla profesyonelce dezenfekte edilmektedir. Bireysel şahıs kaskosu değil, %100 Yasal Rent A Car kaskosu ile güvence altına alınmış olan bu aracımızla seyahat ederken, yolda yaşayabileceğiniz olası mekanik sorunlarda veya kaza durumlarında anında 7/24 yol yardım desteğimiz ve ikame araç tahsisimiz ile tatilinizin veya iş gezinizin asla yarım kalmamasını garanti ediyoruz.",
      "Kurumsal kiralama veya uzun dönem kiralama ihtiyaçlarınızda da esnek ve rekabetçi fiyatlandırma seçenekleri sunuyoruz. Özellikle Denizli merkez, Pamukkale turistik bölgeleri ve Çardak Havalimanı teslimat opsiyonlarımızla, aracınızı doğrudan iniş yaptığınız anda teslim alabilirsiniz. Bu aracı günlük, haftalık veya aylık periyotlarda kiralamak ve en güncel avantajlı fiyat tekliflerini öğrenmek için hemen müşteri temsilcilerimizle iletişime geçerek hızlı rezervasyon sürecini başlatabilirsiniz."
    ],
    year: 2023,
    fuelType: "Benzin",
