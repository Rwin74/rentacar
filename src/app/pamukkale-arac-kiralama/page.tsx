...
export const metadata: Metadata = {
  ...
  description: 'Pamukkale Travertenleri ve Karahayıt bölgesini özgürce gezin. Denizli Pamukkale rent a car hizmetiyle en uygun fiyatlı araçlar burada.',
  alternates: {
    canonical: '/pamukkale-arac-kiralama',
  }
};
...
export default function ServicePage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Pamukkale'deki otelime araç getiriyor musunuz?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Evet, Pamukkale ve Karahayıt bölgesindeki otellerde konaklayan misafirlerimize araçlarını otel otoparkında teslim ediyoruz."
      }
    },
    {
      "@type": "Question",
      "name": "Pamukkale gezisi için hangi araç uygun?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Kişi sayısına ve bagaj durumuna göre ekonomik hatchback araçlardan geniş 9 kişilik VIP minibüslere kadar her araç Pamukkale ziyareti için uygundur."
      }
    }
  ]
};
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Pamukkale Araç Kiralama & Karahayıt Rent A Car",
    ...
    <>
      ...
      <main className="flex-1 w-full bg-white py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-4xl lg:text-5xl font-extrabold text-stone-900 mb-8 tracking-tight">Pamukkale Araç Kiralama ve Gezi Rehberi</h1>
          ...
          <div className="prose prose-stone prose-lg max-w-none text-stone-800 space-y-6">
            <p className="lead text-xl text-stone-800 font-medium">
              Pamukkale Araç Kiralama ve Gezi Rehberi alanında Denizli'nin en güvenilir adresi Emir Rent A Car olarak, siz değerli misafirlerimize kesintisiz, güvenli ve ekonomik çözümler sunuyoruz. Yılların getirdiği sektör tecrübemiz ve genişleyen modern araç filomuzla yanınızdayız.
            </p>
          ...
          <FAQAccordion 
            title="Pamukkale Araç Kiralama ve Gezi Rehberi Hakkında Sıkça Sorulan Sorular" 
            faqs={[{"question":"Pamukkale'deki otelime araç getiriyor musunuz?","answer":"Evet, Pamukkale ve Karahayıt bölgesindeki otellerde konaklayan misafirlerimize araçlarını otel otoparkında teslim ediyoruz."},{"question":"Pamukkale gezisi için hangi araç uygun?","answer":"Kişi sayısına ve bagaj durumuna göre ekonomik hatchback araçlardan geniş 9 kişilik VIP minibüslere kadar her araç Pamukkale ziyareti için uygundur."}]} 
          />
        </div>

        <div className="max-w-6xl mx-auto px-6 mt-16 border-t border-stone-200 pt-16">
          <RelatedCars currentSlug="none" />
          <RelatedServices currentSlug="pamukkale-arac-kiralama" />
