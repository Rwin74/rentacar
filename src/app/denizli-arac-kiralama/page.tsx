...
export const metadata: Metadata = {
  ...
  description: 'Denizli araç kiralama şirketleri arasında Emir Rent A Car kalitesi. Ekonomik, VIP ve SUV araç kiralama seçenekleri ile güvenilir adres.',
  alternates: {
    canonical: '/denizli-arac-kiralama',
  }
};
...
export default function ServicePage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Denizli araç kiralama fiyatları günlük ne kadar?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Denizli araç kiralama fiyatları günlük, haftalık ve aylık sürelerin yanı sıra aracın sınıfına (ekonomik, SUV, lüks) göre değişiklik göstermektedir."
      }
    },
    {
      "@type": "Question",
      "name": "Kiralama için kredi kartı şart mı?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Evet, provizyon (depozito) işlemi için kiracının adına kayıtlı geçerli bir kredi kartı ibraz edilmesi zorunludur."
      }
    },
    {
      "@type": "Question",
      "name": "Günlük kilometre sınırı var mı?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Araç segmentine göre günlük kullanım limitlerimiz mevcuttur. Limit aşımı durumunda km başına cüzi bir ücretlendirme yapılmaktadır."
      }
    }
  ]
};
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Denizli Araç Kiralama | Emir Rent A Car | 2026 Model Araçlar",
    ...
    <>
      ...
      <main className="flex-1 w-full bg-white py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-4xl lg:text-5xl font-extrabold text-stone-900 mb-8 tracking-tight">Denizli Araç Kiralama Hizmetleri</h1>
          ...
          <div className="prose prose-stone prose-lg max-w-none text-stone-800 space-y-6">
            <p className="lead text-xl text-stone-800 font-medium">
              Denizli Araç Kiralama Hizmetleri alanında Denizli'nin en güvenilir adresi Emir Rent A Car olarak, siz değerli misafirlerimize kesintisiz, güvenli ve ekonomik çözümler sunuyoruz. Yılların getirdiği sektör tecrübemiz ve genişleyen modern araç filomuzla yanınızdayız.
            </p>
          ...
          <FAQAccordion 
            title="Denizli Araç Kiralama Hizmetleri Hakkında Sıkça Sorulan Sorular" 
            faqs={[{"question":"Denizli araç kiralama fiyatları günlük ne kadar?","answer":"Denizli araç kiralama fiyatları günlük, haftalık ve aylık sürelerin yanı sıra aracın sınıfına (ekonomik, SUV, lüks) göre değişiklik göstermektedir."},{"question":"Kiralama için kredi kartı şart mı?","answer":"Evet, provizyon (depozito) işlemi için kiracının adına kayıtlı geçerli bir kredi kartı ibraz edilmesi zorunludur."},{"question":"Günlük kilometre sınırı var mı?","answer":"Araç segmentine göre günlük kullanım limitlerimiz mevcuttur. Limit aşımı durumunda km başına cüzi bir ücretlendirme yapılmaktadır."}]} 
          />
        </div>

        <div className="max-w-6xl mx-auto px-6 mt-16 border-t border-stone-200 pt-16">
          <RelatedCars currentSlug="none" />
          <RelatedServices currentSlug="denizli-arac-kiralama" />
